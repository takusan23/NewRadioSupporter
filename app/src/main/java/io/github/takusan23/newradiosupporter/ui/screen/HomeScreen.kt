...
fun HomeScreen(onNavigate: (NavigationLinkList) -> Unit) {
    ...
    val subscriptionIdConfigResultList = LogcatPhysicalChannelConfig.listenLogcatPhysicalChannelConfig(context = context).collectAsStateWithLifecycle(emptyMap())
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            items(multipleNetworkStatusDataList.value) { status ->
                ...
                val configResult = subscriptionIdConfigResultList.value[status.simInfo.subscriptionId]
